                    ...
                    <div class="card-login pt-5 px-2">
                        ...
                        <form class="w-75">
                            ...
                            <div class="text-center mb-5">
                                <a href="./instacomp" type="submit" class="tx btn btn-entrar">Conectar</a>
                            </div>
                        ...
                        <small class="mt-4 mb-3"><a href="./logcol" class="tx">Sou um Colaborador</a></small>
                    </div>
                </div>
            </div>
        </main>
